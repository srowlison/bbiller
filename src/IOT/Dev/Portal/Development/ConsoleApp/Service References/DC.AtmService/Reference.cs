...
namespace ConsoleApp.DC.AtmService {
    ...
    public interface IAtm {
        ...
        ConsoleApp.DC.AtmService.Keys CreatePublicEncryptedPrivateKey();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/CreatePublicEncryptedPrivateKey", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/CreatePublicEncryptedPrivateKeyResponse")]
        System.Threading.Tasks.Task<ConsoleApp.DC.AtmService.Keys> CreatePublicEncryptedPrivateKeyAsync();
        ...
        ConsoleApp.DC.AtmService.Order CreateOrder(string publicKey, decimal amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/CreateOrder", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/CreateOrderResponse")]
        System.Threading.Tasks.Task<ConsoleApp.DC.AtmService.Order> CreateOrderAsync(string publicKey, decimal amount);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAtmChannel : ConsoleApp.DC.AtmService.IAtm, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AtmClient : System.ServiceModel.ClientBase<ConsoleApp.DC.AtmService.IAtm>, ConsoleApp.DC.AtmService.IAtm {
        ...
        public ConsoleApp.DC.AtmService.Keys CreatePublicEncryptedPrivateKey() {
            return base.Channel.CreatePublicEncryptedPrivateKey();
        }
        
        public System.Threading.Tasks.Task<ConsoleApp.DC.AtmService.Keys> CreatePublicEncryptedPrivateKeyAsync() {
            return base.Channel.CreatePublicEncryptedPrivateKeyAsync();
        }
        
        public ConsoleApp.DC.AtmService.Order CreateOrder(string publicKey, decimal amount) {
            return base.Channel.CreateOrder(publicKey, amount);
        }
        
        public System.Threading.Tasks.Task<ConsoleApp.DC.AtmService.Order> CreateOrderAsync(string publicKey, decimal amount) {
