...
namespace Portal.DC.AtmService {
    ...
    public interface IAtm {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/GetConfirmations", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/GetConfirmationsResponse")]
        int GetConfirmations(string publicKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/GetConfirmations", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/GetConfirmationsResponse")]
        System.Threading.Tasks.Task<int> GetConfirmationsAsync(string publicKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/ResolvePrivateKey", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/ResolvePrivateKeyResponse")]
        string ResolvePrivateKey(string encryptedPrivateKey, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://schema.diamondcircle.net/v1/IAtm/ResolvePrivateKey", ReplyAction="http://schema.diamondcircle.net/v1/IAtm/ResolvePrivateKeyResponse")]
        System.Threading.Tasks.Task<string> ResolvePrivateKeyAsync(string encryptedPrivateKey, string password);
    ...
    public partial class AtmClient : System.ServiceModel.ClientBase<Portal.DC.AtmService.IAtm>, Portal.DC.AtmService.IAtm {
        ...
        public int GetConfirmations(string publicKey) {
            return base.Channel.GetConfirmations(publicKey);
        }
        
        public System.Threading.Tasks.Task<int> GetConfirmationsAsync(string publicKey) {
            return base.Channel.GetConfirmationsAsync(publicKey);
        }
        
        public string ResolvePrivateKey(string encryptedPrivateKey, string password) {
            return base.Channel.ResolvePrivateKey(encryptedPrivateKey, password);
        }
        
        public System.Threading.Tasks.Task<string> ResolvePrivateKeyAsync(string encryptedPrivateKey, string password) {
            return base.Channel.ResolvePrivateKeyAsync(encryptedPrivateKey, password);
        }
