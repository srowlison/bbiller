    ...
    public class CardController : Controller
    {
        ...
        private void SendConfirmationEmail(Card card, string privateKey)
        {
            ...
            string emailtxt = "Dear " + user.UserName
                    ...
                    + privateKey
                    + "\n\r PLEASE NOTE THAT WE DO NOT STORE YOUR PRIVATE KEY. PLEASE KEEP THIS PRIVATE KEY SAFE. \n\r  "
                    + "\n\r Copy the link below into your browser address bar and press Enter to follow the link to complete the activation of your Card \n\r  "
