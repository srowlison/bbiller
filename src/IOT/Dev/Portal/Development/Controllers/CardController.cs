    ...
    public class CardController : Controller
    {
        ...
        public ActionResult Activate(Card card)
        {
            try
            {
                ...
                //var user = db.UserProfiles.Where(u => u.UserName == this.UserIdentity).FirstOrDefault();
                //if (user == null)
                //{
                ...
                if (cardResult.TempPublicKey != null)
                {
                    ...
                    db.SaveChanges();
                    SendConfirmationEmail(cardResult, keys.PrivateKey, int.Parse(userId));
                }
                else
                {
                    //This is a standard activation for an ATM issued card. Simply attach a customerId to the card and set to Active
        ...
        private void SendConfirmationEmail(Card card, string privateKey, int userId)
        {
            ...
            var dcUrl = System.Configuration.ConfigurationManager.AppSettings["DCUrl"].ToString();
            ...
            string emailtxt = "Dear " + user.UserName 
                    ...
                    + dcUrl + "Card/ConfirmCard/?str=" + confirmationToken
