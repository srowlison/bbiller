...
namespace Portal.DC.CardService {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="ChargeResult", Namespace="http://schemas.datacontract.org/2004/07/DC.Cards")]
    [System.SerializableAttribute()]
    public partial class ChargeResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string failure_codeField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string failure_messageField;
        ...
        public string failure_code {
            get {
                return this.failure_codeField;
            }
            set {
                if ((object.ReferenceEquals(this.failure_codeField, value) != true)) {
                    this.failure_codeField = value;
                    this.RaisePropertyChanged("failure_code");
                }
            }
        }
        ...
        public string failure_message {
            get {
                return this.failure_messageField;
            }
            set {
                if ((object.ReferenceEquals(this.failure_messageField, value) != true)) {
                    this.failure_messageField = value;
                    this.RaisePropertyChanged("failure_message");
                }
            }
        }
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://payment.diamondcircle.net/v1", ConfigurationName="DC.CardService.ICard")]
    public interface ICard {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/AddCardWithPinLimit", ReplyAction="https://payment.diamondcircle.net/v1/ICard/AddCardWithPinLimitResponse")]
        void AddCardWithPinLimit(
                    string CardId, 
                    string PublicKey, 
                    string Password, 
                    string FirstName, 
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/AddCardWithPinLimit", ReplyAction="https://payment.diamondcircle.net/v1/ICard/AddCardWithPinLimitResponse")]
        System.Threading.Tasks.Task AddCardWithPinLimitAsync(
                    string CardId, 
                    string PublicKey, 
                    string Password, 
                    string FirstName, 
        ...
        Portal.DC.CardService.CCInfo GetCustomerCC(string CardId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/GetCustomerCC", ReplyAction="https://payment.diamondcircle.net/v1/ICard/GetCustomerCCResponse")]
        System.Threading.Tasks.Task<Portal.DC.CardService.CCInfo> GetCustomerCCAsync(string CardId);
        ...
        Portal.DC.CardService.OnlineAccount AddOnlineAccount();
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/AddOnlineAccount", ReplyAction="https://payment.diamondcircle.net/v1/ICard/AddOnlineAccountResponse")]
        System.Threading.Tasks.Task<Portal.DC.CardService.OnlineAccount> AddOnlineAccountAsync();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/MakeFiatPayment", ReplyAction="https://payment.diamondcircle.net/v1/ICard/MakeFiatPaymentResponse")]
        bool MakeFiatPayment(string CardId, string Currency, decimal Amount, int TerminalId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/MakeFiatPayment", ReplyAction="https://payment.diamondcircle.net/v1/ICard/MakeFiatPaymentResponse")]
        System.Threading.Tasks.Task<bool> MakeFiatPaymentAsync(string CardId, string Currency, decimal Amount, int TerminalId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/PayForAndBuyBitcoin", ReplyAction="https://payment.diamondcircle.net/v1/ICard/PayForAndBuyBitcoinResponse")]
        bool PayForAndBuyBitcoin(string CardId, decimal BitcoinAmount, string Currency, decimal Amount, int TerminalId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/PayForAndBuyBitcoin", ReplyAction="https://payment.diamondcircle.net/v1/ICard/PayForAndBuyBitcoinResponse")]
        System.Threading.Tasks.Task<bool> PayForAndBuyBitcoinAsync(string CardId, decimal BitcoinAmount, string Currency, decimal Amount, int TerminalId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCard", ReplyAction="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCardResponse")]
        Portal.DC.CardService.ChargeResult ChargeCreditCard(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCard", ReplyAction="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCardResponse")]
        System.Threading.Tasks.Task<Portal.DC.CardService.ChargeResult> ChargeCreditCardAsync(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICardChannel : Portal.DC.CardService.ICard, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CardClient : System.ServiceModel.ClientBase<Portal.DC.CardService.ICard>, Portal.DC.CardService.ICard {
        ...
        public void AddCardWithPinLimit(
                    string CardId, 
                    string PublicKey, 
                    string Password, 
                    string FirstName, 
                    ...
                    bool Topup, 
                    decimal TopupAmount) {
            base.Channel.AddCardWithPinLimit(CardId, PublicKey, Password, FirstName, LastName, Address, City, Zip, State, Country, Telephone, DOB, EmailAddress, CardHolderName, CardNumber, ExpiryMonth, ExpiryYear, CVC2, PIN, CurrencyCode, Limit, Topup, TopupAmount);
        }
        
        public System.Threading.Tasks.Task AddCardWithPinLimitAsync(
                    string CardId, 
                    string PublicKey, 
                    string Password, 
                    string FirstName, 
                    ...
                    bool Topup, 
                    decimal TopupAmount) {
            return base.Channel.AddCardWithPinLimitAsync(CardId, PublicKey, Password, FirstName, LastName, Address, City, Zip, State, Country, Telephone, DOB, EmailAddress, CardHolderName, CardNumber, ExpiryMonth, ExpiryYear, CVC2, PIN, CurrencyCode, Limit, Topup, TopupAmount);
        }
        
        public Portal.DC.CardService.CCInfo GetCustomerCC(string CardId) {
            return base.Channel.GetCustomerCC(CardId);
        }
        
        public System.Threading.Tasks.Task<Portal.DC.CardService.CCInfo> GetCustomerCCAsync(string CardId) {
        ...
        public Portal.DC.CardService.OnlineAccount AddOnlineAccount() {
            return base.Channel.AddOnlineAccount();
        }
        
        public System.Threading.Tasks.Task<Portal.DC.CardService.OnlineAccount> AddOnlineAccountAsync() {
        ...
        public bool MakeFiatPayment(string CardId, string Currency, decimal Amount, int TerminalId) {
            return base.Channel.MakeFiatPayment(CardId, Currency, Amount, TerminalId);
        }
        
        public System.Threading.Tasks.Task<bool> MakeFiatPaymentAsync(string CardId, string Currency, decimal Amount, int TerminalId) {
            return base.Channel.MakeFiatPaymentAsync(CardId, Currency, Amount, TerminalId);
        }
        
        public bool PayForAndBuyBitcoin(string CardId, decimal BitcoinAmount, string Currency, decimal Amount, int TerminalId) {
            return base.Channel.PayForAndBuyBitcoin(CardId, BitcoinAmount, Currency, Amount, TerminalId);
        }
        
        public System.Threading.Tasks.Task<bool> PayForAndBuyBitcoinAsync(string CardId, decimal BitcoinAmount, string Currency, decimal Amount, int TerminalId) {
            return base.Channel.PayForAndBuyBitcoinAsync(CardId, BitcoinAmount, Currency, Amount, TerminalId);
        }
        
        public Portal.DC.CardService.ChargeResult ChargeCreditCard(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
                    ...
                    string CVC2, 
                    string Currency) {
            return base.Channel.ChargeCreditCard(CCNumber, Amount, FirstName, LastName, Address, City, Zip, State, Country, Telephone, DOB, EmailAddress, CardHolderName, ExpiryMonth, ExpiryYear, CVC2, Currency);
        }
        
        public System.Threading.Tasks.Task<Portal.DC.CardService.ChargeResult> ChargeCreditCardAsync(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
                    ...
                    string CVC2, 
                    string Currency) {
            return base.Channel.ChargeCreditCardAsync(CCNumber, Amount, FirstName, LastName, Address, City, Zip, State, Country, Telephone, DOB, EmailAddress, CardHolderName, ExpiryMonth, ExpiryYear, CVC2, Currency);
        }
    }
}
