...
namespace EftposTestApplication
{
    ...
    public partial class EftposTest : Form
    {
        ...
        private void EftposTest_Load(object sender, EventArgs e)
        {
        ...
        private void lblTransactionAmountLabel_Click(object sender, EventArgs e)
        {

        }

        private void lblTransactionReferenceLabel_Click(object sender, EventArgs e)
        {
        ...
        private void txtTransactionStatus_TextChanged(object sender, EventArgs e)
        {

        }

        private void lblTransactionStatusLabel_Click(object sender, EventArgs e)
        {
