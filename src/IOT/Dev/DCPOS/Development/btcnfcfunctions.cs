...

{
    internal class btcnfcfunctions : DCPOS.INFC
    {
        ...
        public string cbReaderText1 = "ACS ACR1252 1S CL Reader PICC 0";
        public string cbReaderText2 = "ACS ACR1251 1S CL Reader PICC 0"; // Discontinued
        
        public string cbReaderText = "";
     ...
     //        displayOut(2, 0, tmpStr);
        ...
        public bool InitReader()
        {
            ...
            while (ReadersList[indx] != 0)
            {
                ...
                if (rName == cbReaderText1) 
                {

                    cbReaderText = cbReaderText1;
                    return true;
                }
                if (rName == cbReaderText2) 
                {

                    cbReaderText = cbReaderText2;
                    return true;
        ...
        public bool ConnectReader()
        {
           ...
           //SCARD_SHARE_EXCLUSIVE
            retCode = ModWinsCard.SCardConnect(hContext, cbReaderText, ModWinsCard.SCARD_SHARE_SHARED, ModWinsCard.SCARD_PROTOCOL_T1, ref hCard, ref Protocol);
            ...
            else
            {
                ...
                String test1 = ModWinsCard.GetScardErrMsg(retCode);
                connActive = false;
                return false;
            }
        }
