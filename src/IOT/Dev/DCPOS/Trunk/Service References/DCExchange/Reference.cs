...
namespace DCPOS.DCExchange {
    ...
    public interface IExchange {
        ...
        DCPOS.DCExchange.Margin GetMargin(string currencyCode, int terminalId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/IExchange/GetMargin", ReplyAction="https://payment.diamondcircle.net/v1/IExchange/GetMarginResponse")]
        System.Threading.Tasks.Task<DCPOS.DCExchange.Margin> GetMarginAsync(string currencyCode, int terminalId);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IExchangeChannel : DCPOS.DCExchange.IExchange, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ExchangeClient : System.ServiceModel.ClientBase<DCPOS.DCExchange.IExchange>, DCPOS.DCExchange.IExchange {
        ...
        public DCPOS.DCExchange.Margin GetMargin(string currencyCode, int terminalId) {
            return base.Channel.GetMargin(currencyCode, terminalId);
        }
        
        public System.Threading.Tasks.Task<DCPOS.DCExchange.Margin> GetMarginAsync(string currencyCode, int terminalId) {
