...
namespace BitcoinATM.DCCard {
    ...
    public interface ICard {
        ...
        BitcoinATM.DCCard.CCInfo GetCustomerCC(string CardId);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/GetCustomerCC", ReplyAction="https://payment.diamondcircle.net/v1/ICard/GetCustomerCCResponse")]
        System.Threading.Tasks.Task<BitcoinATM.DCCard.CCInfo> GetCustomerCCAsync(string CardId);
        ...
        BitcoinATM.DCCard.ChargeResult ChargeCreditCard(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCard", ReplyAction="https://payment.diamondcircle.net/v1/ICard/ChargeCreditCardResponse")]
        System.Threading.Tasks.Task<BitcoinATM.DCCard.ChargeResult> ChargeCreditCardAsync(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
    ...
    public partial class CardClient : System.ServiceModel.ClientBase<BitcoinATM.DCCard.ICard>, BitcoinATM.DCCard.ICard {
        ...
        public BitcoinATM.DCCard.CCInfo GetCustomerCC(string CardId) {
            return base.Channel.GetCustomerCC(CardId);
        }
        
        public System.Threading.Tasks.Task<BitcoinATM.DCCard.CCInfo> GetCustomerCCAsync(string CardId) {
        ...
        public BitcoinATM.DCCard.ChargeResult ChargeCreditCard(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
        ...
        public System.Threading.Tasks.Task<BitcoinATM.DCCard.ChargeResult> ChargeCreditCardAsync(
                    string CCNumber, 
                    int Amount, 
                    string FirstName, 
                    string LastName, 
