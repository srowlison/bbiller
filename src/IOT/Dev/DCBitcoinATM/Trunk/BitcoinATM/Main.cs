...
namespace BitcoinATM
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            {
                GeneralExceptions("Initialise", "High", ex);
            }
        }
        #region MenuControl
        ...
        private bool PlaceBuyOrder(string PublicKey, decimal btc)
        {
            ...
            {
                GeneralExceptions("PlaceBuyOrder", "High", ex);
                ReturnToMainMenu();
            }   
            return false;
        }
        ...
        private bool PlaceSellOrder(string privatekey, string fromaddress, string toaddress, decimal amount)
        {
            ...
            {
                GeneralExceptions("PlaceSellOrder", "High", ex);
                ReturnToMainMenu();
            }
            return false;
        }
        ...
        private async void GetQuote()
        {
            ...
            {
                GeneralExceptions("GetQuote", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void PrintBitcoinBalance()
        {
            ...
            string receiptText = "DATE:" + DateTime.Now.ToString() + Environment.NewLine;
            ...
            if (!_printer.Initialised)
            {
                ...
                catch (Exception ex)
                {
                   ...
                   GeneralExceptions("PrintBitcoinBalance - Initalise", "Medium", ex);
                   return;
                }
            }
            // Print the receipt.
        ...
        private void PrintTransaction(string OrderType)
        {
                ...
                if (tx > 0)
                {
                    ...
                    if (!_printer.Initialised)
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            lblStatusMessage.Text = "Cannot Print Receipt.";
                            GeneralExceptions("PrintTransaction - Initalise", "Medium", ex);
                            return;
                        }
                    }
                    // Print the receipt.
            ...
            {
                lblStatusMessage.Text = "Cannot Print Receipt.";
                GeneralExceptions("PrintTransaction", "High", ex);
                ReturnToMainMenu();
                return;
            }
        }
        ...
        private void btnAction_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    eftposManager.TransactionReference = "DIGITAL CERTIFICATE";
                    eftposManager.OperatorID = "diamondcircle";
                    eftposManager.PurchaseAmount = 0;
                    eftposManager.CashoutAmount = Convert.ToInt32(Math.Round(CryptoCurrency.Fiat * 100)); 
            ...
            {
                GeneralExceptions("Buy/Sell Action", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void encodeTag()
        {
            ...
            { 
                ...
                if (btcnfc.ConnectReader())
                {
                    ...
                    if (NewTag)
                    {
                        ...
                        PrivateKey = Convert.ToBase64String(key.EncryptedWIFPrivateKey);
            ...
            {
                GeneralExceptions("Encode Tag", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void PurchaseTag()
        {
            ...
            try
            {
                ...
                receiptText += "PRICE: $2.00AUD" + Environment.NewLine;
                receiptText += "http://diamondcircle.net";
                // Initialise the printer if required.
                if (!_printer.Initialised)
                {
            ...
            {
                GeneralExceptions("PurchaseTag", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void btnPurchase_Click(object sender, EventArgs e)
        {
            ...
            eftposManager.CustomerDisplayType = 0;
            eftposManager.PrinterType = 0;
            eftposManager.TransactionReference = "NFC TAG";
            eftposManager.OperatorID = "diamondcircle";
            ...
            {
                GeneralExceptions("PurchaseTagClick", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void PrintPaperBackup()
        {
            ...
            {
                GeneralExceptions("PrintPaperBackup", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        private void tmrRead_Tick(object sender, EventArgs e)
        {
            ...
            {
                GeneralExceptions("tmrRead_Tick", "High", ex);
                ReturnToMainMenu();
            }
        }
        ...
        public void GeneralExceptions(string Category, string Severity, Exception ErrorCondition)
        {
            try
            {
                // DCCard.ServiceError(TerminalId, Category, Severity, ErrorCondition.ToString());
