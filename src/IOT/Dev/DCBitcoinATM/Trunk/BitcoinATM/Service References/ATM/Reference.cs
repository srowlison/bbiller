...
namespace BitcoinATM.ATM {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://node.diamondcircle.net", ConfigurationName="ATM.IAtm")]
    public interface IAtm {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://node.diamondcircle.net/IAtm/TransferCoinsToBuyer", ReplyAction="https://node.diamondcircle.net/IAtm/TransferCoinsToBuyerResponse")]
        string TransferCoinsToBuyer(string address, decimal amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://node.diamondcircle.net/IAtm/TransferCoinsToBuyer", ReplyAction="https://node.diamondcircle.net/IAtm/TransferCoinsToBuyerResponse")]
        System.Threading.Tasks.Task<string> TransferCoinsToBuyerAsync(string address, decimal amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://node.diamondcircle.net/IAtm/ReceiveCoins", ReplyAction="https://node.diamondcircle.net/IAtm/ReceiveCoinsResponse")]
    ...
    public partial class AtmClient : System.ServiceModel.ClientBase<BitcoinATM.ATM.IAtm>, BitcoinATM.ATM.IAtm {
        ...
        public string TransferCoinsToBuyer(string address, decimal amount) {
            return base.Channel.TransferCoinsToBuyer(address, amount);
        }
        
        public System.Threading.Tasks.Task<string> TransferCoinsToBuyerAsync(string address, decimal amount) {
            return base.Channel.TransferCoinsToBuyerAsync(address, amount);
        }
