...
namespace DiamondCircle.PrintingServices
{
    ...
    public class TG2480Printer
    {
        ...
        /// </summary>
        /// <exception cref="DiamondCircle.PrintingServices.PrinterNotFoundException">No printer can be found with the specified vendor id and product id.</exception>
