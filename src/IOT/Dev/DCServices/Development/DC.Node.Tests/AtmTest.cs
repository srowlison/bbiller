...
namespace DC.Node.Tests
{
    ...
    public class AtmTest
    {
        ...
        public void SendCoinRemoteTest()
        {
            ...
            var order = atmsvc.CreateOrder("1DEbdo4BwSfpNVLCMWaoHy7sX3cy3jcLF6", 2M);
        ...
        public void ChargeCard()
        {
          ...
          //     DcPayment.Card cc = new DcPayment.Card();


               DC.Providers.DigitalBTC dbtc = new DC.Providers.DigitalBTC();
          //   cc.ChargeCreditCard("4645790048147002", 100, "Stephen", "Rowlison", "8/23 Gordon St", "Labrador", "4215", "QLD", "Australia", "0400826669", "04031964", "srowlison@diamondcircle.net", "Stephen Rowlison", "07", "17", "171", "AUD");

               // PriceData pricedata = dbtc.GetSpotPrice(2, "USD");
           ...
           //    dbtc.Order((float)pricedata.Price, (float)2M);
