...
namespace TestConsole.srAtm {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="srAtm.IAtm")]
    public interface IAtm {
        ...
        TestConsole.srAtm.Order CreateOrder(double btc, bool verfied);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAtm/CreateOrder", ReplyAction="http://tempuri.org/IAtm/CreateOrderResponse")]
        System.Threading.Tasks.Task<TestConsole.srAtm.Order> CreateOrderAsync(double btc, bool verfied);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAtmChannel : TestConsole.srAtm.IAtm, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AtmClient : System.ServiceModel.ClientBase<TestConsole.srAtm.IAtm>, TestConsole.srAtm.IAtm {
        ...
        public TestConsole.srAtm.Order CreateOrder(double btc, bool verfied) {
            return base.Channel.CreateOrder(btc, verfied);
        }
        
        public System.Threading.Tasks.Task<TestConsole.srAtm.Order> CreateOrderAsync(double btc, bool verfied) {
