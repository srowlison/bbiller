...
namespace TestConsole.srAtm2 {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://node.diamondcircle.net", ConfigurationName="srAtm2.IAtm")]
    public interface IAtm {
        ...
        TestConsole.srAtm2.Keys CreatePublicEncryptedPrivateKey();
        
        [System.ServiceModel.OperationContractAttribute(Action="https://node.diamondcircle.net/IAtm/CreatePublicEncryptedPrivateKey", ReplyAction="https://node.diamondcircle.net/IAtm/CreatePublicEncryptedPrivateKeyResponse")]
        System.Threading.Tasks.Task<TestConsole.srAtm2.Keys> CreatePublicEncryptedPrivateKeyAsync();
        ...
        TestConsole.srAtm2.Order CreateOrder(string publicKey, decimal btc);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://node.diamondcircle.net/IAtm/CreateOrder", ReplyAction="https://node.diamondcircle.net/IAtm/CreateOrderResponse")]
        System.Threading.Tasks.Task<TestConsole.srAtm2.Order> CreateOrderAsync(string publicKey, decimal btc);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAtmChannel : TestConsole.srAtm2.IAtm, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AtmClient : System.ServiceModel.ClientBase<TestConsole.srAtm2.IAtm>, TestConsole.srAtm2.IAtm {
        ...
        public TestConsole.srAtm2.Keys CreatePublicEncryptedPrivateKey() {
            return base.Channel.CreatePublicEncryptedPrivateKey();
        }
        
        public System.Threading.Tasks.Task<TestConsole.srAtm2.Keys> CreatePublicEncryptedPrivateKeyAsync() {
            return base.Channel.CreatePublicEncryptedPrivateKeyAsync();
        }
        
        public TestConsole.srAtm2.Order CreateOrder(string publicKey, decimal btc) {
            return base.Channel.CreateOrder(publicKey, btc);
        }
        
        public System.Threading.Tasks.Task<TestConsole.srAtm2.Order> CreateOrderAsync(string publicKey, decimal btc) {
